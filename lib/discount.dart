...
class _RecommendedProductsState extends State<discount> {
  ...
  Future<void> fetchRecommendedProducts() async {
    try {
      final response = await http.get(Uri.parse('http://20.249.177.153:8080/products/tag'));
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text('今期優惠', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
        ),
        SizedBox(height: 10),
        Card(
